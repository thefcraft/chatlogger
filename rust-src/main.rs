#![allow(dead_code)] #![allow(unused_variables)] #![allow(unused_must_use)] #![allow(unreachable_code)]
...
fn main() {
    // add ons => save and load db
    // change depths prompts according to previous prompt idx
    // change depths prompts according to previous responses idx
    // let mut dataset = Dataset::load(r"C:\ThefCraft\thefcraft-rust\llm_chat_saver\src\dataset.bin");
    // dataset.save(r"C:\ThefCraft\thefcraft-rust\llm_chat_saver\src\dataset.bin");
    // return;
    let mut dataset = Dataset::new();
    let idx = dataset.new_chat();
    let chat: &mut Chats = dataset.get(idx);
    chat.new_message(String::from("p1"), String::from("r1"));
    chat.new_message(String::from("p2"), String::from("r2"));
    chat.new_message(String::from("p3"), String::from("r3"));
    let idx = dataset.new_chat();
    let chat = dataset.get(idx);
    chat.new_message(String::from("p1"), String::from("r1"));
    chat.new_message(String::from("p2"), String::from("r2"));
    chat.new_message(String::from("p3"), String::from("r3"));
    let idx = dataset.new_chat();
    ...
    chat.new_message(String::from("p2"), String::from("r2"));
    chat.new_message(String::from("p3"), String::from("r3"));
    chat.regenerate_last(String::from("r3'"));
    chat.regenerate_last(String::from("r3''"));
    chat.regenerate_last(String::from("r3'''"));
    chat.regenerate_last(String::from("r3''''"));
    chat.edit_last(String::from("p3'"), String::from("r'3"));
    chat.regenerate_last(String::from("r'3'"));
    chat.regenerate_last(String::from("r'3''"));
    chat.regenerate_last(String::from("r'3'''"));
    chat.regenerate_last(String::from("r'3''''"));
    chat.prev_response_last();
    chat.prev_response_last();
    chat.prev_response_last();
    chat.next_response_last();
    chat.prev_prompt_last();
    chat.next_prompt_last();
    chat.edit_last(String::from("p3''"), String::from("r''3"));
    chat.edit_last(String::from("p3'''"), String::from("r'''3"));
    chat.new_message(String::from("p4'''"), String::from("r'''4"));
    chat.regenerate(6, String::from("r'''3'"));
    chat.regenerate(6, String::from("r'''3'"));
    chat.edit(3, String::from("p2'"), String::from("r'2"));

    // chat.prev_prompt(3);
    // chat.prev_prompt(5);
    // chat.prev_prompt(5);
    // chat.next_response(6);
    // chat.next_response(6);
    // chat.prev_response(6); 

    chat.regenerate(2, String::from("r'''2'"));
    chat.edit(1, String::from("p1'"), String::from("r'2"));
